...
function Registration(props) {
    ...
    submitCred = async () => {
        fetch("http://10.0.2.2:3000/studentsignup", {
            method: 'POST',
            headers: {
            ...
            .then(async (data) => {
                ...
                try {
                    ...
                    props.navigation.replace("Student Login")
                } catch (e) {
            ...
            <KeyboardAvoidingView behavior="position">
                ...
                <View style={styles.textContainer}>
                    <Form style={{ marginHorizontal: 0 }}>
                        ...
                        <Item style={{ marginHorizontal: 30, borderBottomWidth: 3, marginVertical: 10 }} floatingLabel>
                            <Label style={{ marginVertical: -12, color: "white" }}>Department</Label>
                            <Input style={{ color: "white" }} onChangeText={(e) => setDepartment(e)} />
                        </Item>
                        <Item style={{ marginHorizontal: 30, borderBottomWidth: 3, marginVertical: 10 }} floatingLabel>
                            <Label style={{ marginVertical: -12, color: "white" }}>Semester</Label>
                            <Input style={{ color: "white" }} onChangeText={(e) => setSemester(e)} />
                        </Item>
                        <Item style={{ marginHorizontal: 30, borderBottomWidth: 3, marginVertical: 10 }} floatingLabel>
