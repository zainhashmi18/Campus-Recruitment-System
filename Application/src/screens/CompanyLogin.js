...
import Logo from "../Images/cmp.jpg";
...
function CompanyLogin(props) {
    ...
    const submitCred = async () => {
        fetch("http://10.0.2.2:3000/companysignin", {
            method: "POST",
            headers: {
            ...
            .then(async (data) => {
                try {
                    ...
                    props.navigation.replace("Main2")
                } catch (e) {
                ...
                <View style={styles.textContainer}>
                    <Form style={{ marginHorizontal: 0 }}>
                        ...
                        <View style={styles.btnContainer}>
                            ...
                            <TouchableOpacity onPress={() => props.navigation.navigate('CMP Registration')} style={styles.btn}><Text style={styles.text}>Register</Text></TouchableOpacity>
                        </View>
                    </Form>
