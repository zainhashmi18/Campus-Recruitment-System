...
function AdminLogin(props) {
    ...
    const submitCred = async () => {
        fetch("http://10.0.2.2:3000/adminsignin", {
            method: "POST",
            headers: {
            ...
            .then(async (data) => {
                try {
                    ...
                    props.navigation.replace("Main3")
                } catch (e) {
                ...
                <View style={styles.textContainer}>
                    <Form style={{ marginHorizontal: 0 }}>
                        <Item style={{ borderColor: "#D80132", marginHorizontal: 30, borderBottomWidth: 3, marginVertical: 10 }} floatingLabel>
                            <Label style={{ borderColor: "#D80132", marginVertical: -12, color: "black" }}>Email</Label>
                        ...
                        <View style={styles.btnContainer}>
                            ...
                            <TouchableOpacity onPress={() => props.navigation.navigate('Admin Registration')} style={styles.btn}><Text style={styles.text}>Register</Text></TouchableOpacity>
                        </View>
                    </Form>
                </View>
